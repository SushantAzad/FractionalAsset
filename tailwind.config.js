...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'elevation-1': '0 1px 3px 0 rgba(0, 0, 0, 0.04), 0 1px 2px 0 rgba(0, 0, 0, 0.06)',
        ...
        'elevation-4': '0 25px 50px -12px rgba(0, 0, 0, 0.12), 0 10px 15px -3px rgba(0, 0, 0, 0.06)',
      },
      animation: {
        ...
        'slide-out': 'slideOut 300ms cubic-bezier(0.4, 0.0, 0.2, 1)',
      },
      keyframes: {
        shimmer: {
